...
// Buffers
uint8_t inputBuffer[SIZE_INPUT_BUFFER];
...
{
    // Init fifos
    fifo_init( &inputFifo, inputBuffer, sizeof(inputBuffer) );      // UART receive
    ...
    putsUSART((char *)"Copyright (C) 2014 Grodans Paradis AB, Sweden\r\n");
...
///////////////////////////////////////////////////////////////////////////////
// sendReceiveEventVSCP
//

BOOL sendReceiveEventVSCP( void )
{
    uint8_t i;
