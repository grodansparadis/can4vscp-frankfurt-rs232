...
#define  ADC_CLOCK_KHZ           200        /* ADC clock in Khz, Valid only if ADC_DYNAMIC_CLOCK = 1 */
...
/* 
   ...
   and if you change channel using the "adc_set_channel()" command, after at least one measurement 
