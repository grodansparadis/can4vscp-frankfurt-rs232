...
![](/bus_drops.jpg){.align-center width="700" query="?700"}
...
![](/can_bus.png){.align-center width="600" query="?600"}
...
![](//prototype2_terminator.png){.align-center width="600" query="?600"}
...
Copyright (c) 2000-2015 [Åke Hedman](/mailto/akhe@grodansparadis.com),
[Paradise of the Frog / Grodans Paradis
